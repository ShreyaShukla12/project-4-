...
<form action="<%=ORSView.TIMETABLE_LIST_CTL %>" method="post"> 
	...
	<table width ="100%">
		...
		<input type="text" name="subname" placeholder="Enter Subject Name" value="<%=ServletUtility.getParameter("subnamd", request)%>">
						&emsp; 
			<%--   <label> Exam Date: </label>
			<input type="text"  name="exam"  id ="udate5" placehlder="Enter Exam Date" size="21" value="<%=ServletUtility.getParameter("exam", request)%>">	 --%>
			
			<%--  <label>Exam Time:</label>
		<input type="text" name="extime" placeholder="Enter Exam Time" value="<%=ServletUtility.getParameter("extime", request)%>"> 
			 --%>
